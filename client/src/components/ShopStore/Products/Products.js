        ...
        return (
            ...
            <div className="Content">
                    <div className="ContentTitle">
                        ...
                        <h2 className="CategoryTitle">Produk</h2>
                    </div>
                    <div className="ContentBody">
                        <div className="SideMenu">
                            <h3 className="SideMenuTitle">Filter</h3>
                            <div className="Filter">
                                <p className="FilterTitle">Kategori</p>
                                <ul>
                                    {
                           ...
                           <div className="Filter">
                               <p className="FilterTitle">Harga</p>
                               <div>
                                    <button onClick={() => this.applyFilter({price:1} )} className="FilterButton">Rendah ke Tinggi</button>
                               </div>
                               <div>
                                    <button onClick={() => this.applyFilter({price: -1})} className="FilterButton">Tinggi ke Rendah</button>
                               </div>
