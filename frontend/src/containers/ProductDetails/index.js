                    ...
                    <div className="ProductDetailsWrapper">
                        <div className="ProductDetailsImage">
                            <div className="ProductDetailsImageWrapper">
                                <img src={product.productPic[0].img} width="300" height="300" alt="" />
                            </div>
                            <div className="ActionButtonWrapper">
                                <button onClick={() => { this.addToCart(product._id, product.price, product.name, product.productPic[0].img) }}><i className="fas fa-shopping-cart"></i>&nbsp;Masukkan Keranjang</button>
                        ...
                        <div className="ProductDetails">
                            ...
                            <p className="ProductPrice">Rp {product.price}</p>
                            <h3>Stok : {product.stock}</h3><br></br>
