...
class Cart extends Component{
    ...
    changeQuantity = (e, productId) => {
        ...
        // this.updateCart(productId, parseInt(quantity));
    }
                        ...
                        <div className="CartDetails">
                            ...
                            <div className="CardBody">
                                ...
                                <div className="PlaceOrder">
                                    <button className="PlaceOrderButton" onClick={() => this.props.history.push('/place-order')}>Buat Pesanan</button>
                                </div>
